...
const pdfStyles = StyleSheet.create({
  ...
  header: { marginBottom: 20, borderBottom: '2px solid #111111', paddingBottom: 10 },
  schoolName: { fontSize: 24, fontWeight: 'bold', textAlign: 'center', marginBottom: 5 },
  schoolInfo: { fontSize: 10, textAlign: 'center', color: '#666666' },
  resultTitle: { fontSize: 16, fontWeight: 'bold', textAlign: 'center', marginTop: 15, marginBottom: 15 },
  studentInfo: { marginBottom: 20, padding: 10, backgroundColor: '#f5f5f5', borderRadius: 5 },
  infoRow: { flexDirection: 'row', marginBottom: 5 },
  infoLabel: { fontSize: 10, fontWeight: 'bold', width: '40%' },
  infoValue: { fontSize: 10, width: '60%' },
  table: { marginTop: 10, marginBottom: 20 },
  tableHeader: { flexDirection: 'row', backgroundColor: '#111111', padding: 8, color: '#ffffff' },
  tableRow: { flexDirection: 'row', borderBottom: '1px solid #e5e5e5', padding: 8 },
  tableCol1: { width: '50%', fontSize: 10 },
  tableCol2: { width: '15%', fontSize: 10, textAlign: 'center' },
  tableCol3: { width: '15%', fontSize: 10, textAlign: 'center' },
  tableCol4: { width: '20%', fontSize: 10, textAlign: 'center' },
  summary: { marginTop: 10, marginBottom: 20, padding: 15, backgroundColor: '#f5f5f5', borderRadius: 5 },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  summaryLabel: { fontSize: 12, fontWeight: 'bold' },
  summaryValue: { fontSize: 12, fontWeight: 'bold', color: '#111111' },
  commentsSection: { marginTop: 20 },
  commentBox: { marginBottom: 15, padding: 10, border: '1px solid #e5e5e5', borderRadius: 5 },
  commentLabel: { fontSize: 10, fontWeight: 'bold', marginBottom: 5, color: '#111111' },
  commentText: { fontSize: 10, lineHeight: 1.5 },
  footer: { position: 'absolute', bottom: 30, left: 30, right: 30, textAlign: 'center', fontSize: 8, color: '#666666', borderTop: '1px solid #e5e5e5', paddingTop: 10 },
  gradeScale: { marginTop: 20, padding: 10, backgroundColor: '#f9f9f9', borderRadius: 5 },
  gradeScaleTitle: { fontSize: 10, fontWeight: 'bold', marginBottom: 5 },
  gradeScaleText: { fontSize: 8, lineHeight: 1.4 },
});
