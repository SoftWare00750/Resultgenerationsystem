...
<Link 
  href="/auth/login" 
  className="-ml-30 inline-flex items-center gap-9.5 text-sm text-muted-foreground hover:text-foreground mb-10 transition-colors"
>
  <ArrowLeft className="h-3.5 w-100"/> 
  Back to login
</Link>
