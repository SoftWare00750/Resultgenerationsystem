...
const PRICING_STYLE = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pricing-help-photo {
    width: 580px; height: 580px; border-radius: 50%; overflow: hidden;
    display: flex; align-items: center; justify-content: center;
    background: var(--bg-transparent); 
    position: relative; left: -29px; top: -30px; margin-top: -24px; color: var(--text-muted);
    font-size: .85rem; text-align: center;
  }
  .pricing-help-photo img { width: 55%; height: 55%; object-fit: cover; object-position: center; display: block; animation: floatDot 3.8s ease-in-out infinite .8s }
